...
export default function Navbar() {
  ...
  return (
    <nav className="no-print sticky top-0 z-40 border-b px-3 py-3 sm:px-6 sm:py-4" style={{ background: 'var(--nav-bg)', borderColor: 'var(--nav-border)' }}>
      {/* Top gradient line */}
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 cursor-pointer group" onClick={() => navigate('/')}>
          <img
            src="/logo.png"
            alt="GST Invoice"
            className="w-8 h-8 sm:w-12 sm:h-12 rounded-2xl shadow-xl shadow-purple-500/20 group-hover:shadow-purple-500/40 group-hover:scale-105 transition-all object-cover"
          />
        ...
        <div className="flex items-center gap-0.5 sm:gap-1 overflow-x-auto no-scrollbar">
          <NavLink to="/" end className={({ isActive }) =>
            `text-xs sm:text-sm font-semibold px-2 sm:px-4 py-1.5 sm:py-2 rounded-xl transition-all duration-200 whitespace-nowrap ${
              isActive
                ? 'text-white bg-gradient-to-r from-indigo-500 to-purple-600 shadow-lg shadow-indigo-500/30'
                : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100/80 dark:hover:bg-white/5'
            }`
          ...
          <NavLink to="/invoice/new" className={({ isActive }) =>
            `text-xs sm:text-sm font-semibold px-2 sm:px-4 py-1.5 sm:py-2 rounded-xl transition-all duration-200 flex items-center gap-1 whitespace-nowrap ${
              isActive
          ...
          <div className="relative">
            <button
              ...
              className="text-xs sm:text-sm font-semibold px-2 sm:px-4 py-1.5 sm:py-2 rounded-xl text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-100/80 dark:hover:bg-white/5 transition-all flex items-center gap-1 whitespace-nowrap"
            >
              More
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="w-8 h-8 sm:w-11 sm:h-11 rounded-xl flex items-center justify-center text-lg sm:text-xl transition-all hover:scale-105 active:scale-95"
